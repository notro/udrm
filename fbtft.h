...
#define write_reg(par, ...)	mipi_dbi_write(par->mipi.reg, ##__VA_ARGS__)
...
{                                                                          \
	return fbtft_mipi_probe(_name, _display, spi);                     \
}                                                                          \
									   \
static int fbtft_driver_remove_spi(struct spi_device *spi)                 \
{                                                                          \
	return fbtft_mipi_remove(spi);                                     \
}                                                                          \
									   \
